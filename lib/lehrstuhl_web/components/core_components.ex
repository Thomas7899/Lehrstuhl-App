defmodule LehrstuhlWeb.CoreComponents do
  @moduledoc """
  ...
  def input(assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <input
        ...
        class={[
          "mt-2 block w-full bg-gray-800 rounded-lg text-white focus:ring-0 sm:text-sm sm:leading-6",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LehrstuhlWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LehrstuhlWeb.Gettext, "errors", msg, opts)
    end
  end
