...
# --- NEUE KLAUSUREN IN DER ZUKUNFT ---

klausur6 = Repo.insert!(%Klausur{
...
klausur7 = Repo.insert!(%Klausur{
  id: "3a7b3300-ae7f-11eb-bcbc-0242ac130002",
  kenner: "MIS301",
  beschreibung: "Modellierung betrieblicher Informationssysteme - Vertiefung",
  punkteGesamt: 80,
  semester: "SS26",
...
# Zusätzliche Ergebnisse für PHY101 (klausur4)
Repo.insert!(%Klausurergebnis{
  punkte: 68,
  note: 2.7,
  status: :bestanden,
